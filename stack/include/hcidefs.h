...
#define HCI_VSC_HEADLESS_BREDR_DEV_GET_LIST       0x1
#define HCI_VSC_HEADLESS_DEV_ADD                  0x2
#define HCI_VSC_HEADLESS_DEV_DEL                  0x3
#define HCI_VSC_HEADLESS_ENABLE                   0x4
#define HCI_VSC_HEADLESS_SET_SCAN_MODE            0x5
#define HCI_VSC_HEADLESS_SET_LE_ADV_DATA          0x6
#define HCI_VSC_ADD_AV_DEVICE_TO_HEADLESS         0x7
#define HCI_VSC_ENABLE_WAKE_UP_TEST               0x8
#define HCI_VSC_ERASE_PATCH                       0x9
#define HCI_VSC_READ_FLASH_BURNING_STATUS         0xA
#define HCI_VSC_READ_LAST_MEMORY                  0xB
#define HCI_VSC_FIRMWARE_UPGRADE                  0xC

#define HCI_VSC_WRITE_LOCAL_IRK                   0xD
#define HCI_VSC_HOGP_ADD_DEVICE_INFO              0xE
#define HCI_VSC_HOGP_DELETE_DEVICE_INFO           0xF
#define HCI_VSC_HOGP_READ_DEVICE_INFO             0x10
#define HCI_VSC_HOGP_SET_SCAN_PARA                0x11



typedef struct {
#define HCI_VSC_MAX_LEN 512
	unsigned char sub_opcode;
	unsigned char buf[HCI_VSC_MAX_LEN];
} tHCI_VSC_NPL;
