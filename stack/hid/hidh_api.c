...
/******************************************************************************
**
** Function         hid_known_hogp_device
**
** Description      check if this device is  of type HOGP Device
**
** Returns          TRUE if device is HOGP Device else FALSE
**
*******************************************************************************/
BOOLEAN hid_known_hogp_device (BD_ADDR bd_addr)
{
	return hid_known_hid_device (bd_addr);
}
