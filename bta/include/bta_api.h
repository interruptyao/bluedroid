...
BTA_API extern tBTA_STATUS BTA_DmNPLSpecificCommand (UINT16 opcode, UINT8 sub_opcode,UINT8 param_len,UINT8 *p_param_buf, tBTA_VENDOR_CMPL_CBACK *p_cback);
...
/*******************************************************************************
**
** Function        BTA_DMUpdateEir
**
** Description      This function is used for updating EIR record
**
** Returns          void
**
*******************************************************************************/
